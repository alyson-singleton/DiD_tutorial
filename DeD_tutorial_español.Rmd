...
# esto significa que tenemos 23 años para cada centro de salud.
...
Tómese un momento para explorar los datos sobre el dengue creando un gráfico de incidencia a lo largo del tiempo. En primer lugar, cree un gráfico que muestre la incidencia del dengue en cada centro de salud a lo largo del tiempo, coloreado por grupo de exposición.

```{r}
# crear una figura con la incidencia de cada centro de salud durante el periodo de estudio, coloreada según el tratamiento (<5 km) y el control (>10 km)
...
# gráfico de incidencia para cada centro de salud
